...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # load image1
        input1 = cv2.imread(self.datas['input1']['image'][index], -1)
        ...
        # load image2
        input2 = cv2.imread(self.datas['input2']['image'][index], -1)
    ...
    def __len__(self):
        ...
        return len(self.datas['input2']['image'])
...
class TestDataset(Dataset):
    ...
    # TODO According to input 2 length, it is not equal to input 1 length
    def __len__(self):
